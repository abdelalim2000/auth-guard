...
<div
    ...
    @if (Route::has('login'))
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            @elseauth('web')
                <a href="{{ url('/') }}" class="text-sm text-gray-700 underline">Home</a>
                <a href="javascript:void(0)" onclick="event.preventDefault();document.querySelector('#logout').submit()"
                   class="text-sm text-gray-700 underline">logout</a>
    ...
    @auth('admin')
        <h1 class="display-1">Logged in as admin</h1>
    @elseauth('web')
        <h1 class="display-1">Logged in as User</h1>
    @endauth
